...
export const RegsiterContainer = styled.div`
...
export const RegisterForm = styled.div`
  width: ${props => props.centervenum ? '100%' : '500px'};
  max-width: 500px;
  height: ${props => props.centervenum ? 'auto' : '600px'};
  display: flex;
...
export const Button = styled.button`
  ...
  outline: none;
  cursor: pointer;
  background-color: rgb(22, 71, 123);
  color: white;
  margin-top: 20px;
